...
class Commande extends Mysql
{
	...
	public function details($id)
	{
		...
		$prod->_datecreation= $row['datecreation'];
		return $prod;
	}
	...
	{
		$q = "INSERT INTO commande(id,nom,prenom,email,adress,datecreation) VALUES 
		(  null	,'$this->_nom','$this->_prenom','$this->_email','$this->_adress',NOW()
	);";
	$res = $this->requete($q);
...
public function modifier(){
	...
	email = '$this->_email',
	adress = '$this->_adress'
	datecreation='$this->_'$this->_datecreation''
	WHERE id = '$this->_id' ";
