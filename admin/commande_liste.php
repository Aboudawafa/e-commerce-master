        ...
        <tbody id="resultat-diporama"> 
          ...
          foreach($liste as $data )
          {
           ...
           <!-- <td><?php echo $data->_email; ?></td>
            ...
            <td>
              <a class="btn btn-primary" href="commande_detail.php?id=<?php echo $data->_id; ?>">
                <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>  Détails
              </a>
            </td>
             <td>
              <a class="btn btn-primary" href="Imprimer.php?id=<?php echo $data->_id; ?>">
